...
$(".section-4-mobile").each(function (index) {
  ...
  // DESKTOP - Section7
$(".section-7").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".div-bg-sect7");
  ...
  $(".section-7").each(function (index) {
      let triggerElement = $(this);
      let targetElement = $(".section-7-content");
  ...
  $(".section-7").each(function (index) {
      let triggerElement = $(this);
      let targetElement = $(".div-sect7-pt2-content");
  ...
  $(".section-7").each(function (index) {
     ...
     // MOBILE sect7
$(".section-7-mobile").each(function (index) {
    let triggerElement = $(this);
    let targetElement = $(".div-bg-sect7-mobile");
